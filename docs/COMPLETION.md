...
| Currently green: executed behavioural witnesses completed for 97 of the 97 parsed command-matrix catalog IDs. This row is green only when the witnessed and denominator counts are equal. |
