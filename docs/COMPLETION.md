...
| Currently red: executed behavioural witnesses completed for 96 of the 97 parsed command-matrix catalog IDs. This row is green only when the witnessed and denominator counts are equal. |
