...
| Currently red: executed behavioural witnesses completed for 65 of the 96 parsed command-matrix catalog IDs. This row is green only when the witnessed and denominator counts are equal. |
