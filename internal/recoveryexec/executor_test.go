...
func TestAppendQuestionRequestDerivesOnlyFromBlockedSource(t *testing.T) {
	...
	appendEvent(runstate.EventAdapterProbed, map[string]any{
		...
		"negotiated_features": []any{}, "truncated_resolutions": []any{}, "delivered_feedback": []any{}, "advisory_dimensions": []any{}, "execution_dependency_hash": "sha256:dependency", "identity_versions": versions,
	})
