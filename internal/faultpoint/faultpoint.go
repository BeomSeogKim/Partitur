...
const (
	...
	EdgeLifecycleDraftPerformerCompletedToNoBlockingFailure EdgeID = "lifecycle.draft_performer_completed_to_no_blocking_failure"
)
...
const (
	...
	PointPromotionBeforeRootRename        PointID = "promotion.before_root_rename"
	PointPromotionRootRenamed             PointID = "promotion.root_renamed"
)
